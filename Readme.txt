...
-  Supervised learning requires labeled data (benign or malicious) to learn patterns. Since the initial PCAP files ("pcap\AMF_3_1.cap") 
use to train the model contained replay attacks with very few malicious samples, I needed to generate labels for each data sample to train the model effectively.
